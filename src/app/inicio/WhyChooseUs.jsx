        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="mb-3 order-2 lg:order-1">
            <div className="relative pe-0 lg:pe-5">
              ...
              <button
                className="swiper-button-next !z-30 !w-10 !h-10 bg-white/90 backdrop-blur-sm rounded-full shadow-sm text-primary-600 hover:bg-white hover:shadow-md hover:text-primary transition-all duration-300 absolute top-1/2 -translate-y-1/2 right-4 transform hover:scale-110"
              ...
              <button
                className="swiper-button-prev !z-30 !w-10 !h-10 bg-white/90 backdrop-blur-sm rounded-full shadow-sm text-primary-600 hover:bg-white hover:shadow-md hover:text-primary transition-all duration-300 absolute top-1/2 -translate-y-1/2 left-4 transform hover:scale-110"
